...
def main():
    ...
    parser.add_argument('--foldings_dataset', default='/home/Mirele/Documentos/0_0_DOUTORADO/0_DISTANCE_EVOLUTIVE/test/janelas_deslizantes/8_riboswitch/riboswitch_windows_dual.pkl',
    ...
    parser.add_argument('--out_csv', default='../results_model/janelas_deslizantes/8_riboswitch/detection_results_set1_TL.csv')
