...
def main():
    ...
    parser.add_argument('--foldings_dataset',
                        default='../data/test_data/NUMBER_riboswitch/riboswitch_windows_dual.pkl',
                        help='Path to foldings dataset (.pkl)')
    parser.add_argument('--checkpoint',
                        default=None,
                        help=('Path to model checkpoint '
                              'If not set, uses ../models/test/DL_DISTANCE_model_full.pt'))
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--out_csv',
                        default='../results_model/output_DISTANCE_NUMBER_riboswitch.csv')
    ...
    opt = pickle.load(open(f'../results_model/{args.model_name}/DISTANCE_hyperparams.pkl', "rb"))
    opt.device = device
    ...
    checkpoint_path = args.checkpoint or f'../models/{args.model_name}/DL_DISTANCE_model_full.pt'
    ...
    #overwrites out_csv (includes extra columns if --explain)
    df.to_csv(args.out_csv, index=False)
